...
class Config:
    ...
    DATABASE_NAME=os.environ.get("DATABASE_NAME", "DynaVcPlayerBot")
...
4. `SESSION_STRING` : __Generate From here [GenerateStringName](https://replit.com/@DYNANETWORK/DynaVcPlayerBot#main.py)__
