...
async def start(client, message):
    ...
    buttons = [
        [
            InlineKeyboardButton('⚠️ Channel', url='https://t.me/DYNA_NETWORK'),
            InlineKeyboardButton('Source ⚠️', url='PHLE 500 RS PAYTM KR FIR DUNGA SOURCE CODE')
        ],
        [
...
async def repo_(client, message):
    buttons = [
        [
            InlineKeyboardButton('⚠️ Repository', url='PHLE 500 RS PAYTM KAR FIR DUNGA MAI TERKO SOURCE CODE'),
            InlineKeyboardButton('Channel ⚠️', url='https://t.me/DYNA_NETWORK'),
        ],
        [
            InlineKeyboardButton("👮‍♂️ Dev", url='https://t.me/DYNA_OPTIMISE'),
            InlineKeyboardButton('Close ❌', callback_data='close'),
        ]
    ]
    await message.reply("<b>The source code of this bot is public and can be found at <a href=https://github.com/DYNANETWORK/DynaVcPlayerBot>VCPlayerBot.</a>\nYou can deploy your own bot and use in your group.\n\nFeel free to star☀️ the repo if you liked it 🙃.</b>", reply_markup=InlineKeyboardMarkup(buttons), disable_web_page_preview=True)
    await delete_messages([message])
